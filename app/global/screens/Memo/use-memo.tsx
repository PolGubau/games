...
export const useMemo = () => {
  ...
  const getHint = () => {
    ...
    const randomTileId =
      notGuessedWithoutCopy[Math.floor(Math.random() * notGuessedWithoutCopy.length)].id;
  ...
  const isVisible = (id: TileId) => selected.includes(id) || guessed.includes(id);
