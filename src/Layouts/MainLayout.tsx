...
`);
  return (
    <main className="bg-primary md:p-8 w-screen h-[100svh] grid grid-rows-[auto,1fr] gap-6 overflow-hidden">
      <nav className="bg-secondary-50 w-full p-2 md:rounded-full justify-start gap-2 md:gap-4 flex items-center z-10">
        <div className="flex items-center bg-primary-900 h-full aspect-square rounded-full text-secondary-50 justify-center text-3xl md:p-4">
          <IoGameController />
        </div>
